 ...
 */
@OutsideMessageHandler(value = 0, uri = "/hall/userLogin", protocol = Protocol.HTTP)
public class UserLoginAction extends HttpServerMessageDispatcher {
    ...
    public void handle(ChannelHandlerContext ctx, HttpPacket httpPacket) {
        ...
        String page = "pages/joinRoom.html";
