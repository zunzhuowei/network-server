...
public class UdpLoginGameRoomAction extends ServerMessageDispatcher {

    private static final Logger logger = LoggerFactory.getLogger(UdpLoginGameRoomAction.class);
