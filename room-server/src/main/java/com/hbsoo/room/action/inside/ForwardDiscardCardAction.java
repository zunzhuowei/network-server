...
public class ForwardDiscardCardAction extends ServerMessageDispatcher {

    private static final Logger logger = LoggerFactory.getLogger(ForwardDiscardCardAction.class);
    @Autowired
