 ...
 */
@InsideServerMessageHandler(1006)
public class ForwardReadyStartGameAction extends ServerMessageDispatcher {

    private static final Logger logger = LoggerFactory.getLogger(ForwardReadyStartGameAction.class);
    @Autowired
    ...
    public void handle(ChannelHandlerContext ctx, NetworkPacket.Decoder decoder) {
        ...
        redirectAndSwitchProtocol(ctx, ProtocolType.OUTSIDE_WEBSOCKET, decoder.toBuilder().msgType(1006));
    }
