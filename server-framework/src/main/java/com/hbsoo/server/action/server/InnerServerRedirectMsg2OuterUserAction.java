...
public class InnerServerRedirectMsg2OuterUserAction extends ServerMessageDispatcher {

    private static final Logger logger = LoggerFactory.getLogger(InnerServerRedirectMsg2OuterUserAction.class);
    @Autowired
